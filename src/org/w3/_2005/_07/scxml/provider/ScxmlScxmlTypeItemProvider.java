...
/**
 * This is the item provider adapter for a {@link org.w3._2005._07.scxml.ScxmlScxmlType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScxmlScxmlTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlScxmlType_script_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlScxmlType_script_feature", "_UI_ScxmlScxmlType_type"),
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlScxmlType_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlScxmlType_id_feature", "_UI_ScxmlScxmlType_type"),
				 ScxmlPackage.Literals.SCXML_SCXML_TYPE__ID,
				 true,
				 false,
				 false,
	...
	protected void addInitialPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlScxmlType_initial_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlScxmlType_initial_feature", "_UI_ScxmlScxmlType_type"),
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlScxmlType_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlScxmlType_version_feature", "_UI_ScxmlScxmlType_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScxmlPackage.Literals.SCXML_SCXML_TYPE__STATE);
			childrenFeatures.add(ScxmlPackage.Literals.SCXML_SCXML_TYPE__SCRIPT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ScxmlScxmlType"));
	}
	...
	public String getText(Object object) {
		String label = ((ScxmlScxmlType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ScxmlScxmlType_type") :
			getString("_UI_ScxmlScxmlType_type") + " " + label;
	}
