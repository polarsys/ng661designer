...
/**
 * This is the item provider adapter for a {@link org.w3._2005._07.scxml.ScxmlSendType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScxmlSendTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlSendType_param_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlSendType_param_feature", "_UI_ScxmlSendType_type"),
	...
	protected void addEventPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlSendType_event_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlSendType_event_feature", "_UI_ScxmlSendType_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScxmlPackage.Literals.SCXML_SEND_TYPE__PARAM);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ScxmlSendType"));
	}
	...
	public String getText(Object object) {
		String label = ((ScxmlSendType)object).getEvent();
		return label == null || label.length() == 0 ?
			getString("_UI_ScxmlSendType_type") :
			getString("_UI_ScxmlSendType_type") + " " + label;
	}
