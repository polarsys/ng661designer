...
import org.w3._2005._07.scxml.parts.DocumentRootPropertiesEditionPart;
 ...
 * 
 */
public class DocumentRootPropertiesEditionPartForm extends DefaultValueSectionPropertiesEditionPart implements IFormPropertiesEditionPart, DocumentRootPropertiesEditionPart {
	...
	public void createControls(final FormToolkit widgetFactory, Composite view) {
		...
		documentRootStep
			.addStep(ScxmlViewsRepository.DocumentRoot.Properties.class);
		
		composer = new PartComposer(documentRootStep) {

			@Override
			public Composite addToPart(Composite parent, Object key) {
				if (key == ScxmlViewsRepository.DocumentRoot.Properties.class) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(ScxmlMessages.DocumentRootPropertiesEditionPart_PropertiesGroupLabel);
	...
	public String getTitle() {
		return ScxmlMessages.DocumentRoot_Part_Title;
	}
