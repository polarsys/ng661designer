 ...
 * 
 */
public class ScxmlOnexecuteTypePropertiesEditionPartImpl extends DefaultValueCompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ScxmlOnexecuteTypePropertiesEditionPart {
	 ...
	 * 
	 */
	public ScxmlOnexecuteTypePropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(ScxmlMessages.ScxmlOnexecuteTypePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createSendAdvancedTableComposition(Composite parent) {
		this.send = new ReferencesTable(getDescription(ScxmlViewsRepository.ScxmlOnexecuteType.Properties.send, ScxmlMessages.ScxmlOnexecuteTypePropertiesEditionPart_SendLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScxmlOnexecuteTypePropertiesEditionPartImpl.this, ScxmlViewsRepository.ScxmlOnexecuteType.Properties.send, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				send.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScxmlOnexecuteTypePropertiesEditionPartImpl.this, ScxmlViewsRepository.ScxmlOnexecuteType.Properties.send, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				send.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScxmlOnexecuteTypePropertiesEditionPartImpl.this, ScxmlViewsRepository.ScxmlOnexecuteType.Properties.send, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				send.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScxmlOnexecuteTypePropertiesEditionPartImpl.this, ScxmlViewsRepository.ScxmlOnexecuteType.Properties.send, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				send.refresh();
			}
		...
		this.send.setHelpText(propertiesEditionComponent.getHelpContent(ScxmlViewsRepository.ScxmlOnexecuteType.Properties.send, ScxmlViewsRepository.SWT_KIND));
		this.send.createControls(parent);
		this.send.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScxmlOnexecuteTypePropertiesEditionPartImpl.this, ScxmlViewsRepository.ScxmlOnexecuteType.Properties.send, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createScriptAdvancedTableComposition(Composite parent) {
		this.script = new ReferencesTable(getDescription(ScxmlViewsRepository.ScxmlOnexecuteType.Properties.script, ScxmlMessages.ScxmlOnexecuteTypePropertiesEditionPart_ScriptLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScxmlOnexecuteTypePropertiesEditionPartImpl.this, ScxmlViewsRepository.ScxmlOnexecuteType.Properties.script, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				script.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScxmlOnexecuteTypePropertiesEditionPartImpl.this, ScxmlViewsRepository.ScxmlOnexecuteType.Properties.script, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				script.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScxmlOnexecuteTypePropertiesEditionPartImpl.this, ScxmlViewsRepository.ScxmlOnexecuteType.Properties.script, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				script.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScxmlOnexecuteTypePropertiesEditionPartImpl.this, ScxmlViewsRepository.ScxmlOnexecuteType.Properties.script, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				script.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.script.setHelpText(propertiesEditionComponent.getHelpContent(ScxmlViewsRepository.ScxmlOnexecuteType.Properties.script, ScxmlViewsRepository.SWT_KIND));
		this.script.createControls(parent);
		this.script.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScxmlOnexecuteTypePropertiesEditionPartImpl.this, ScxmlViewsRepository.ScxmlOnexecuteType.Properties.script, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
