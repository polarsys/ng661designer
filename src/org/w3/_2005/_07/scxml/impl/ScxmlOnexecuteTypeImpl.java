 ...
 *   <li>{@link org.w3._2005._07.scxml.impl.ScxmlOnexecuteTypeImpl#getSend <em>Send</em>}</li>
...
public class ScxmlOnexecuteTypeImpl extends MinimalEObjectImpl.Container implements ScxmlOnexecuteType {
	...
	public EList<ScxmlSendType> getSend() {
		if (send == null) {
			send = new EObjectContainmentEList<ScxmlSendType>(ScxmlSendType.class, this, ScxmlPackage.SCXML_ONEXECUTE_TYPE__SEND);
		}
		return send;
	}
