 ...
 * 
 */
public interface GestureAreaPrimitivePropertiesEditionPart {
	...
	/**
	 * @return the acceptedGesture
	 * 
	 */
	public String getAcceptedGesture();

	/**
	 * Defines a new acceptedGesture
	 * @param newValue the new acceptedGesture to set
	 * 
	 */
