 ...
 * 
 */
public interface PointerAreaPrimitivePropertiesEditionPart {
	...
	/**
	 * @return the acceptedButtons
	 * 
	 */
	public String getAcceptedButtons();

	/**
	 * Defines a new acceptedButtons
	 * @param newValue the new acceptedButtons to set
	 * 
	 */
	...
	/**
	 * Defines a new passThrough
	 * @param newValue the new passThrough to set
	 * 
	 */
	...
	/**
	 * @return the preventStealing
	 * 
	 */
	public String getPreventStealing();

	/**
	 * Defines a new preventStealing
	 * @param newValue the new preventStealing to set
	 * 
	 */
