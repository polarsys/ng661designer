 ...
 * 
 */
public class ImportTypePropertiesEditionPartImpl extends DefaultValueCompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ImportTypePropertiesEditionPart {
	 ...
	 * 
	 */
	public ImportTypePropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(Part2Messages.ImportTypePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createFileText(Composite parent) {
		...
		file = SWTUtils.createScrollableText(parent, SWT.BORDER);
		...
		file.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ImportTypePropertiesEditionPartImpl.this, Part2ViewsRepository.ImportType.Properties.file, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, file.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.ImportType.Properties.file, Part2ViewsRepository.SWT_KIND), null); //$NON-NLS-1$
