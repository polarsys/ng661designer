 ...
 * 
 */
public interface RectPrimitivePropertiesEditionPart {
	...
	/**
	 * Defines a new height
	 * @param newValue the new height to set
	 * 
	 */
	...
	/**
	 * Defines a new rx
	 * @param newValue the new rx to set
	 * 
	 */
	...
	/**
	 * Defines a new ry
	 * @param newValue the new ry to set
	 * 
	 */
