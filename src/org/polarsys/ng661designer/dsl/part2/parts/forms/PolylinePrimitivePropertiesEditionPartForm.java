 ...
 * 
 */
public class PolylinePrimitivePropertiesEditionPartForm extends DefaultValueSectionPropertiesEditionPart implements IFormPropertiesEditionPart, PolylinePrimitivePropertiesEditionPart {
	 ...
	 */
	public PolylinePrimitivePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public PolylinePrimitivePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(Part2Messages.PolylinePrimitivePropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PolylinePrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.PolylinePrimitive.Properties.id,
		...
		id.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PolylinePrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.PolylinePrimitive.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
				}
			}
		});
		EditingUtils.setID(id, Part2ViewsRepository.PolylinePrimitive.Properties.id);
		EditingUtils.setEEFtype(id, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.PolylinePrimitive.Properties.id, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPointsText(FormToolkit widgetFactory, Composite parent) {
		...
		points.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PolylinePrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.PolylinePrimitive.Properties.points,
		...
		points.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PolylinePrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.PolylinePrimitive.Properties.points, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, points.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.PolylinePrimitive.Properties.points, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createDrawingPriorityText(FormToolkit widgetFactory, Composite parent) {
		...
		drawingPriority.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PolylinePrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.PolylinePrimitive.Properties.drawingPriority,
		...
		drawingPriority.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PolylinePrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.PolylinePrimitive.Properties.drawingPriority, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, drawingPriority.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.PolylinePrimitive.Properties.drawingPriority, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStrokeText(FormToolkit widgetFactory, Composite parent) {
		...
		stroke.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PolylinePrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.PolylinePrimitive.Properties.stroke,
		...
		stroke.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PolylinePrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.PolylinePrimitive.Properties.stroke, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, stroke.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.PolylinePrimitive.Properties.stroke, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStrokeDasharrayText(FormToolkit widgetFactory, Composite parent) {
		...
		strokeDasharray.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PolylinePrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.PolylinePrimitive.Properties.strokeDasharray,
		...
		strokeDasharray.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PolylinePrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.PolylinePrimitive.Properties.strokeDasharray, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, strokeDasharray.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.PolylinePrimitive.Properties.strokeDasharray, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStrokeDashoffsetText(FormToolkit widgetFactory, Composite parent) {
		...
		strokeDashoffset.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PolylinePrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.PolylinePrimitive.Properties.strokeDashoffset,
		...
		strokeDashoffset.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PolylinePrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.PolylinePrimitive.Properties.strokeDashoffset, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, strokeDashoffset.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.PolylinePrimitive.Properties.strokeDashoffset, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStrokeLinecapText(FormToolkit widgetFactory, Composite parent) {
		...
		strokeLinecap.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PolylinePrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.PolylinePrimitive.Properties.strokeLinecap,
		...
		strokeLinecap.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PolylinePrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.PolylinePrimitive.Properties.strokeLinecap, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, strokeLinecap.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.PolylinePrimitive.Properties.strokeLinecap, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStrokeLinejoinText(FormToolkit widgetFactory, Composite parent) {
		...
		strokeLinejoin.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PolylinePrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.PolylinePrimitive.Properties.strokeLinejoin,
		...
		strokeLinejoin.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PolylinePrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.PolylinePrimitive.Properties.strokeLinejoin, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, strokeLinejoin.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.PolylinePrimitive.Properties.strokeLinejoin, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStrokeMiterlimitText(FormToolkit widgetFactory, Composite parent) {
		...
		strokeMiterlimit.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PolylinePrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.PolylinePrimitive.Properties.strokeMiterlimit,
		...
		strokeMiterlimit.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PolylinePrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.PolylinePrimitive.Properties.strokeMiterlimit, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, strokeMiterlimit.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.PolylinePrimitive.Properties.strokeMiterlimit, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStrokeOpacityText(FormToolkit widgetFactory, Composite parent) {
		...
		strokeOpacity.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PolylinePrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.PolylinePrimitive.Properties.strokeOpacity,
		...
		strokeOpacity.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PolylinePrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.PolylinePrimitive.Properties.strokeOpacity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, strokeOpacity.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.PolylinePrimitive.Properties.strokeOpacity, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStrokewidthText(FormToolkit widgetFactory, Composite parent) {
		...
		strokewidth.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PolylinePrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.PolylinePrimitive.Properties.strokewidth,
		...
		strokewidth.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PolylinePrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.PolylinePrimitive.Properties.strokewidth, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, strokewidth.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.PolylinePrimitive.Properties.strokewidth, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createTransformText(FormToolkit widgetFactory, Composite parent) {
		...
		transform.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PolylinePrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.PolylinePrimitive.Properties.transform,
		...
		transform.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PolylinePrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.PolylinePrimitive.Properties.transform, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, transform.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.PolylinePrimitive.Properties.transform, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createVisibilityText(FormToolkit widgetFactory, Composite parent) {
		...
		visibility.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PolylinePrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.PolylinePrimitive.Properties.visibility,
		...
		visibility.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PolylinePrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.PolylinePrimitive.Properties.visibility, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, visibility.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.PolylinePrimitive.Properties.visibility, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
