 ...
 * 
 */
public class RectPrimitivePropertiesEditionPartForm extends DefaultValueSectionPropertiesEditionPart implements IFormPropertiesEditionPart, RectPrimitivePropertiesEditionPart {
	 ...
	 */
	public RectPrimitivePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public RectPrimitivePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(rectPrimitiveStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == Part2ViewsRepository.RectPrimitive.Properties.rx) {
					return createRxText(widgetFactory, parent);
				}
				if (key == Part2ViewsRepository.RectPrimitive.Properties.ry) {
					return createRyText(widgetFactory, parent);
				}
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(Part2Messages.RectPrimitivePropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.id,
		...
		id.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
				}
			}
		});
		EditingUtils.setID(id, Part2ViewsRepository.RectPrimitive.Properties.id);
		EditingUtils.setEEFtype(id, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.id, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createClipPathText(FormToolkit widgetFactory, Composite parent) {
		...
		clipPath.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.clipPath,
		...
		clipPath.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.clipPath, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, clipPath.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.clipPath, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createClipRuleText(FormToolkit widgetFactory, Composite parent) {
		...
		clipRule.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.clipRule,
		...
		clipRule.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.clipRule, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, clipRule.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.clipRule, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createDrawingPriorityText(FormToolkit widgetFactory, Composite parent) {
		...
		drawingPriority.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.drawingPriority,
		...
		drawingPriority.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.drawingPriority, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, drawingPriority.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.drawingPriority, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createFillText(FormToolkit widgetFactory, Composite parent) {
		...
		fill.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.fill,
		...
		fill.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.fill, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, fill.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.fill, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createFillOpacityText(FormToolkit widgetFactory, Composite parent) {
		...
		fillOpacity.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.fillOpacity,
		...
		fillOpacity.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.fillOpacity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, fillOpacity.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.fillOpacity, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createFillRuleText(FormToolkit widgetFactory, Composite parent) {
		...
		fillRule.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.fillRule,
		...
		fillRule.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.fillRule, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, fillRule.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.fillRule, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createHeightText(FormToolkit widgetFactory, Composite parent) {
		...
		height.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.height,
		...
		height.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.height, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, height.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.height, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createRxText(FormToolkit widgetFactory, Composite parent) {
		...
		rx = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		rx.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		rx.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.rx,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, rx.getText()));
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(
									RectPrimitivePropertiesEditionPartForm.this,
									Part2ViewsRepository.RectPrimitive.Properties.rx,
		...
		rx.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.rx, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, rx.getText()));
				}
			}
		});
		EditingUtils.setID(rx, Part2ViewsRepository.RectPrimitive.Properties.rx);
		EditingUtils.setEEFtype(rx, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.rx, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createRyText(FormToolkit widgetFactory, Composite parent) {
		...
		ry = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		ry.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		ry.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.ry,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, ry.getText()));
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(
									RectPrimitivePropertiesEditionPartForm.this,
									Part2ViewsRepository.RectPrimitive.Properties.ry,
		...
		ry.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.ry, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, ry.getText()));
				}
			}
		});
		EditingUtils.setID(ry, Part2ViewsRepository.RectPrimitive.Properties.ry);
		EditingUtils.setEEFtype(ry, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.ry, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStrokeText(FormToolkit widgetFactory, Composite parent) {
		...
		stroke.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.stroke,
		...
		stroke.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.stroke, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, stroke.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.stroke, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStrokeDasharrayText(FormToolkit widgetFactory, Composite parent) {
		...
		strokeDasharray.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.strokeDasharray,
		...
		strokeDasharray.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.strokeDasharray, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, strokeDasharray.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.strokeDasharray, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStrokeDashoffsetText(FormToolkit widgetFactory, Composite parent) {
		...
		strokeDashoffset.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.strokeDashoffset,
		...
		strokeDashoffset.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.strokeDashoffset, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, strokeDashoffset.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.strokeDashoffset, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStrokeLinecapText(FormToolkit widgetFactory, Composite parent) {
		...
		strokeLinecap.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.strokeLinecap,
		...
		strokeLinecap.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.strokeLinecap, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, strokeLinecap.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.strokeLinecap, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStrokeLinejoinText(FormToolkit widgetFactory, Composite parent) {
		...
		strokeLinejoin.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.strokeLinejoin,
		...
		strokeLinejoin.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.strokeLinejoin, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, strokeLinejoin.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.strokeLinejoin, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStrokeMiterlimitText(FormToolkit widgetFactory, Composite parent) {
		...
		strokeMiterlimit.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.strokeMiterlimit,
		...
		strokeMiterlimit.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.strokeMiterlimit, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, strokeMiterlimit.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.strokeMiterlimit, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStrokeOpacityText(FormToolkit widgetFactory, Composite parent) {
		...
		strokeOpacity.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.strokeOpacity,
		...
		strokeOpacity.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.strokeOpacity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, strokeOpacity.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.strokeOpacity, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStrokewidthText(FormToolkit widgetFactory, Composite parent) {
		...
		strokewidth.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.strokewidth,
		...
		strokewidth.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.strokewidth, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, strokewidth.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.strokewidth, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createTransformText(FormToolkit widgetFactory, Composite parent) {
		...
		transform.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.transform,
		...
		transform.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.transform, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, transform.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.transform, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createVisibilityText(FormToolkit widgetFactory, Composite parent) {
		...
		visibility.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.visibility,
		...
		visibility.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.visibility, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, visibility.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.visibility, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createWidthText(FormToolkit widgetFactory, Composite parent) {
		...
		width.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.width,
		...
		width.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.width, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, width.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.width, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createXText(FormToolkit widgetFactory, Composite parent) {
		...
		x.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.x,
		...
		x.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.x, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, x.getText()));
				}
			}
		});
		EditingUtils.setID(x, Part2ViewsRepository.RectPrimitive.Properties.x);
		EditingUtils.setEEFtype(x, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.x, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createYText(FormToolkit widgetFactory, Composite parent) {
		...
		y.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RectPrimitivePropertiesEditionPartForm.this,
							Part2ViewsRepository.RectPrimitive.Properties.y,
		...
		y.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RectPrimitivePropertiesEditionPartForm.this, Part2ViewsRepository.RectPrimitive.Properties.y, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, y.getText()));
				}
			}
		});
		EditingUtils.setID(y, Part2ViewsRepository.RectPrimitive.Properties.y);
		EditingUtils.setEEFtype(y, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.RectPrimitive.Properties.y, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
