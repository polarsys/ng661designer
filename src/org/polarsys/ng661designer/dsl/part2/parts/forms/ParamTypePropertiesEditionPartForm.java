 ...
 * 
 */
public class ParamTypePropertiesEditionPartForm extends DefaultValueSectionPropertiesEditionPart implements IFormPropertiesEditionPart, ParamTypePropertiesEditionPart {
	 ...
	 */
	public ParamTypePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public ParamTypePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(Part2Messages.ParamTypePropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ParamTypePropertiesEditionPartForm.this,
							Part2ViewsRepository.ParamType.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ParamTypePropertiesEditionPartForm.this, Part2ViewsRepository.ParamType.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, Part2ViewsRepository.ParamType.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.ParamType.Properties.name, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createModalityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		modality.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ParamTypePropertiesEditionPartForm.this, Part2ViewsRepository.ParamType.Properties.modality, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getModality()));
			}

		});
		modality.setID(Part2ViewsRepository.ParamType.Properties.modality);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.ParamType.Properties.modality, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createTypeText(FormToolkit widgetFactory, Composite parent) {
		...
		type.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ParamTypePropertiesEditionPartForm.this,
							Part2ViewsRepository.ParamType.Properties.type,
		...
		type.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ParamTypePropertiesEditionPartForm.this, Part2ViewsRepository.ParamType.Properties.type, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, type.getText()));
				}
			}
		});
		EditingUtils.setID(type, Part2ViewsRepository.ParamType.Properties.type);
		EditingUtils.setEEFtype(type, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.ParamType.Properties.type, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
