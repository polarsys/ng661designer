 ...
 * 
 */
public class CustomIntegerTypeElementTypePropertiesEditionPartForm extends DefaultValueSectionPropertiesEditionPart implements IFormPropertiesEditionPart, CustomIntegerTypeElementTypePropertiesEditionPart {
	 ...
	 */
	public CustomIntegerTypeElementTypePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public CustomIntegerTypeElementTypePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(Part2Messages.CustomIntegerTypeElementTypePropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CustomIntegerTypeElementTypePropertiesEditionPartForm.this,
							Part2ViewsRepository.CustomIntegerTypeElementType.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CustomIntegerTypeElementTypePropertiesEditionPartForm.this, Part2ViewsRepository.CustomIntegerTypeElementType.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, Part2ViewsRepository.CustomIntegerTypeElementType.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.CustomIntegerTypeElementType.Properties.name, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMaxText(FormToolkit widgetFactory, Composite parent) {
		...
		max.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CustomIntegerTypeElementTypePropertiesEditionPartForm.this,
							Part2ViewsRepository.CustomIntegerTypeElementType.Properties.max,
		...
		max.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CustomIntegerTypeElementTypePropertiesEditionPartForm.this, Part2ViewsRepository.CustomIntegerTypeElementType.Properties.max, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, max.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.CustomIntegerTypeElementType.Properties.max, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMinText(FormToolkit widgetFactory, Composite parent) {
		...
		min.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CustomIntegerTypeElementTypePropertiesEditionPartForm.this,
							Part2ViewsRepository.CustomIntegerTypeElementType.Properties.min,
		...
		min.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CustomIntegerTypeElementTypePropertiesEditionPartForm.this, Part2ViewsRepository.CustomIntegerTypeElementType.Properties.min, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, min.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.CustomIntegerTypeElementType.Properties.min, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createResolutionText(FormToolkit widgetFactory, Composite parent) {
		...
		resolution.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CustomIntegerTypeElementTypePropertiesEditionPartForm.this,
							Part2ViewsRepository.CustomIntegerTypeElementType.Properties.resolution,
		...
		resolution.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CustomIntegerTypeElementTypePropertiesEditionPartForm.this, Part2ViewsRepository.CustomIntegerTypeElementType.Properties.resolution, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, resolution.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.CustomIntegerTypeElementType.Properties.resolution, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createUnitText(FormToolkit widgetFactory, Composite parent) {
		...
		unit.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CustomIntegerTypeElementTypePropertiesEditionPartForm.this,
							Part2ViewsRepository.CustomIntegerTypeElementType.Properties.unit,
		...
		unit.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CustomIntegerTypeElementTypePropertiesEditionPartForm.this, Part2ViewsRepository.CustomIntegerTypeElementType.Properties.unit, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, unit.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Part2ViewsRepository.CustomIntegerTypeElementType.Properties.unit, Part2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
