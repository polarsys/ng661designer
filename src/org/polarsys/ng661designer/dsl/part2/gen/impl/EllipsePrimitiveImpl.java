...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ellipse Primitive</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getChildElements <em>Child Elements</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getRectangle <em>Rectangle</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getCircle <em>Circle</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getEllipse <em>Ellipse</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getLine <em>Line</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getPolyline <em>Polyline</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getPolygon <em>Polygon</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getPath <em>Path</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getImage <em>Image</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getText <em>Text</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getArc <em>Arc</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getCrown <em>Crown</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getPolarLine <em>Polar Line</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getPointerArea <em>Pointer Area</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getTouchArea <em>Touch Area</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getGestureArea <em>Gesture Area</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getScrollWheelArea <em>Scroll Wheel Area</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getKeyboardInput <em>Keyboard Input</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getCompositions <em>Compositions</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getClipPath <em>Clip Path</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getClipRule <em>Clip Rule</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getCx <em>Cx</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getCy <em>Cy</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getDrawingPriority <em>Drawing Priority</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getFill <em>Fill</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getFillOpacity <em>Fill Opacity</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getFillRule <em>Fill Rule</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getRx <em>Rx</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getRy <em>Ry</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getStroke <em>Stroke</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getStrokeDasharray <em>Stroke Dasharray</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getStrokeDashoffset <em>Stroke Dashoffset</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getStrokeLinecap <em>Stroke Linecap</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getStrokeLinejoin <em>Stroke Linejoin</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getStrokeMiterlimit <em>Stroke Miterlimit</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getStrokeOpacity <em>Stroke Opacity</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getStrokewidth <em>Strokewidth</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getTransform <em>Transform</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.EllipsePrimitiveImpl#getVisibility <em>Visibility</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EllipsePrimitiveImpl extends ClipRepresentationTypesImpl implements EllipsePrimitive {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @ordered
	 */
	protected static final Object CX_EDEFAULT = Part2Factory.eINSTANCE.createFromString(Part2Package.eINSTANCE.getPositionType(), "0");
	 ...
	 * @ordered
	 */
	protected static final Object CY_EDEFAULT = Part2Factory.eINSTANCE.createFromString(Part2Package.eINSTANCE.getPositionType(), "0");
	 ...
	 * @generated
	 */
	protected EllipsePrimitiveImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Part2Package.eINSTANCE.getEllipsePrimitive();
	}
	...
	public EList<RepresentationTypes> getChildElements() {
		if (childElements == null) {
			childElements = new EObjectContainmentEList<RepresentationTypes>(RepresentationTypes.class, this, Part2Package.ELLIPSE_PRIMITIVE__CHILD_ELEMENTS);
		}
	...
	public EList<GroupPrimitive> getGroup() {
		if (group == null) {
			group = new EObjectResolvingEList.Unsettable<GroupPrimitive>(GroupPrimitive.class, this, Part2Package.ELLIPSE_PRIMITIVE__GROUP);
		}
		return group;
	}
	...
	public EList<ChildPrimitive> getChildren() {
		if (children == null) {
			children = new EObjectResolvingEList.Unsettable<ChildPrimitive>(ChildPrimitive.class, this, Part2Package.ELLIPSE_PRIMITIVE__CHILDREN);
		}
		return children;
	}
	...
	public EList<RectPrimitive> getRectangle() {
		if (rectangle == null) {
			rectangle = new EObjectResolvingEList.Unsettable<RectPrimitive>(RectPrimitive.class, this, Part2Package.ELLIPSE_PRIMITIVE__RECTANGLE);
		}
		return rectangle;
	}
	...
	public EList<CirclePrimitive> getCircle() {
		if (circle == null) {
			circle = new EObjectResolvingEList.Unsettable<CirclePrimitive>(CirclePrimitive.class, this, Part2Package.ELLIPSE_PRIMITIVE__CIRCLE);
		}
		return circle;
	}
	...
	public EList<EllipsePrimitive> getEllipse() {
		if (ellipse == null) {
			ellipse = new EObjectResolvingEList.Unsettable<EllipsePrimitive>(EllipsePrimitive.class, this, Part2Package.ELLIPSE_PRIMITIVE__ELLIPSE);
		}
		return ellipse;
	}
	...
	public EList<LinePrimitive> getLine() {
		if (line == null) {
			line = new EObjectResolvingEList.Unsettable<LinePrimitive>(LinePrimitive.class, this, Part2Package.ELLIPSE_PRIMITIVE__LINE);
		}
		return line;
	}
	...
	public EList<PolylinePrimitive> getPolyline() {
		if (polyline == null) {
			polyline = new EObjectResolvingEList.Unsettable<PolylinePrimitive>(PolylinePrimitive.class, this, Part2Package.ELLIPSE_PRIMITIVE__POLYLINE);
		}
		return polyline;
	}
	...
	public EList<PolygonPrimitive> getPolygon() {
		if (polygon == null) {
			polygon = new EObjectResolvingEList.Unsettable<PolygonPrimitive>(PolygonPrimitive.class, this, Part2Package.ELLIPSE_PRIMITIVE__POLYGON);
		}
		return polygon;
	}
	...
	public EList<PathPrimitive> getPath() {
		if (path == null) {
			path = new EObjectResolvingEList.Unsettable<PathPrimitive>(PathPrimitive.class, this, Part2Package.ELLIPSE_PRIMITIVE__PATH);
		}
		return path;
	}
	...
	public EList<ImagePrimitive> getImage() {
		if (image == null) {
			image = new EObjectResolvingEList.Unsettable<ImagePrimitive>(ImagePrimitive.class, this, Part2Package.ELLIPSE_PRIMITIVE__IMAGE);
		}
		return image;
	}
	...
	public EList<TextPrimitive> getText() {
		if (text == null) {
			text = new EObjectResolvingEList.Unsettable<TextPrimitive>(TextPrimitive.class, this, Part2Package.ELLIPSE_PRIMITIVE__TEXT);
		}
		return text;
	}
	...
	public EList<ArcComponent> getArc() {
		if (arc == null) {
			arc = new EObjectResolvingEList.Unsettable<ArcComponent>(ArcComponent.class, this, Part2Package.ELLIPSE_PRIMITIVE__ARC);
		}
		return arc;
	}
	...
	public EList<CrownComponent> getCrown() {
		if (crown == null) {
			crown = new EObjectResolvingEList.Unsettable<CrownComponent>(CrownComponent.class, this, Part2Package.ELLIPSE_PRIMITIVE__CROWN);
		}
		return crown;
	}
	...
	public EList<PolarLineComponent> getPolarLine() {
		if (polarLine == null) {
			polarLine = new EObjectResolvingEList.Unsettable<PolarLineComponent>(PolarLineComponent.class, this, Part2Package.ELLIPSE_PRIMITIVE__POLAR_LINE);
		}
		return polarLine;
	}
	...
	public EList<PointerAreaPrimitive> getPointerArea() {
		if (pointerArea == null) {
			pointerArea = new EObjectResolvingEList.Unsettable<PointerAreaPrimitive>(PointerAreaPrimitive.class, this, Part2Package.ELLIPSE_PRIMITIVE__POINTER_AREA);
		}
		return pointerArea;
	}
	...
	public EList<PointerAreaPrimitive> getTouchArea() {
		if (touchArea == null) {
			touchArea = new EObjectResolvingEList.Unsettable<PointerAreaPrimitive>(PointerAreaPrimitive.class, this, Part2Package.ELLIPSE_PRIMITIVE__TOUCH_AREA);
		}
		return touchArea;
	}
	...
	public EList<GestureAreaPrimitive> getGestureArea() {
		if (gestureArea == null) {
			gestureArea = new EObjectResolvingEList.Unsettable<GestureAreaPrimitive>(GestureAreaPrimitive.class, this, Part2Package.ELLIPSE_PRIMITIVE__GESTURE_AREA);
		}
		return gestureArea;
	}
	...
	public EList<ScrollWheelAreaPrimitive> getScrollWheelArea() {
		if (scrollWheelArea == null) {
			scrollWheelArea = new EObjectResolvingEList.Unsettable<ScrollWheelAreaPrimitive>(ScrollWheelAreaPrimitive.class, this, Part2Package.ELLIPSE_PRIMITIVE__SCROLL_WHEEL_AREA);
		}
	...
	public EList<KeyboardInputPrimitive> getKeyboardInput() {
		if (keyboardInput == null) {
			keyboardInput = new EObjectResolvingEList.Unsettable<KeyboardInputPrimitive>(KeyboardInputPrimitive.class, this, Part2Package.ELLIPSE_PRIMITIVE__KEYBOARD_INPUT);
		}
	...
	public EList<WidgetComposition> getCompositions() {
		if (compositions == null) {
			compositions = new EObjectResolvingEList.Unsettable<WidgetComposition>(WidgetComposition.class, this, Part2Package.ELLIPSE_PRIMITIVE__COMPOSITIONS);
		}
		return compositions;
	}
	...
	public void setClipPath(String newClipPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__CLIP_PATH, oldClipPath, clipPath, !oldClipPathESet));
	}
	...
	public void unsetClipPath() {
		...
		clipPathESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.ELLIPSE_PRIMITIVE__CLIP_PATH, oldClipPath, CLIP_PATH_EDEFAULT, oldClipPathESet));
	}
	...
	public void setClipRule(String newClipRule) {
		...
		clipRuleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__CLIP_RULE, oldClipRule, clipRule, !oldClipRuleESet));
	}
	...
	public void unsetClipRule() {
		...
		clipRuleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.ELLIPSE_PRIMITIVE__CLIP_RULE, oldClipRule, CLIP_RULE_EDEFAULT, oldClipRuleESet));
	}
	...
	public void setCx(Object newCx) {
		...
		cxESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__CX, oldCx, cx, !oldCxESet));
	}
	...
	public void unsetCx() {
		...
		cxESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.ELLIPSE_PRIMITIVE__CX, oldCx, CX_EDEFAULT, oldCxESet));
	}
	...
	public void setCy(Object newCy) {
		...
		cyESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__CY, oldCy, cy, !oldCyESet));
	}
	...
	public void unsetCy() {
		...
		cyESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.ELLIPSE_PRIMITIVE__CY, oldCy, CY_EDEFAULT, oldCyESet));
	}
	...
	public void setDrawingPriority(Object newDrawingPriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__DRAWING_PRIORITY, oldDrawingPriority, drawingPriority, !oldDrawingPriorityESet));
	}
	...
	public void unsetDrawingPriority() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.ELLIPSE_PRIMITIVE__DRAWING_PRIORITY, oldDrawingPriority, DRAWING_PRIORITY_EDEFAULT, oldDrawingPriorityESet));
	}
	...
	public void setFill(Object newFill) {
		...
		fillESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__FILL, oldFill, fill, !oldFillESet));
	}
	...
	public void unsetFill() {
		...
		fillESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.ELLIPSE_PRIMITIVE__FILL, oldFill, FILL_EDEFAULT, oldFillESet));
	}
	...
	public void setFillOpacity(Object newFillOpacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__FILL_OPACITY, oldFillOpacity, fillOpacity, !oldFillOpacityESet));
	}
	...
	public void unsetFillOpacity() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.ELLIPSE_PRIMITIVE__FILL_OPACITY, oldFillOpacity, FILL_OPACITY_EDEFAULT, oldFillOpacityESet));
	}
	...
	public void setFillRule(Object newFillRule) {
		...
		fillRuleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__FILL_RULE, oldFillRule, fillRule, !oldFillRuleESet));
	}
	...
	public void unsetFillRule() {
		...
		fillRuleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.ELLIPSE_PRIMITIVE__FILL_RULE, oldFillRule, FILL_RULE_EDEFAULT, oldFillRuleESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__ID, oldId, id));
	}
	...
	public void setRx(Object newRx) {
		...
		rx = newRx;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__RX, oldRx, rx));
	}
	...
	public void setRy(Object newRy) {
		...
		ry = newRy;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__RY, oldRy, ry));
	}
	...
	public void setStroke(Object newStroke) {
		...
		strokeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__STROKE, oldStroke, stroke, !oldStrokeESet));
	}
	...
	public void unsetStroke() {
		...
		strokeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.ELLIPSE_PRIMITIVE__STROKE, oldStroke, STROKE_EDEFAULT, oldStrokeESet));
	}
	...
	public void setStrokeDasharray(String newStrokeDasharray) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__STROKE_DASHARRAY, oldStrokeDasharray, strokeDasharray, !oldStrokeDasharrayESet));
	}
	...
	public void unsetStrokeDasharray() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.ELLIPSE_PRIMITIVE__STROKE_DASHARRAY, oldStrokeDasharray, STROKE_DASHARRAY_EDEFAULT, oldStrokeDasharrayESet));
	}
	...
	public void setStrokeDashoffset(Object newStrokeDashoffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__STROKE_DASHOFFSET, oldStrokeDashoffset, strokeDashoffset, !oldStrokeDashoffsetESet));
	}
	...
	public void unsetStrokeDashoffset() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.ELLIPSE_PRIMITIVE__STROKE_DASHOFFSET, oldStrokeDashoffset, STROKE_DASHOFFSET_EDEFAULT, oldStrokeDashoffsetESet));
	}
	...
	public void setStrokeLinecap(String newStrokeLinecap) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__STROKE_LINECAP, oldStrokeLinecap, strokeLinecap, !oldStrokeLinecapESet));
	}
	...
	public void unsetStrokeLinecap() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.ELLIPSE_PRIMITIVE__STROKE_LINECAP, oldStrokeLinecap, STROKE_LINECAP_EDEFAULT, oldStrokeLinecapESet));
	}
	...
	public void setStrokeLinejoin(String newStrokeLinejoin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__STROKE_LINEJOIN, oldStrokeLinejoin, strokeLinejoin, !oldStrokeLinejoinESet));
	}
	...
	public void unsetStrokeLinejoin() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.ELLIPSE_PRIMITIVE__STROKE_LINEJOIN, oldStrokeLinejoin, STROKE_LINEJOIN_EDEFAULT, oldStrokeLinejoinESet));
	}
	...
	public void setStrokeMiterlimit(Object newStrokeMiterlimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__STROKE_MITERLIMIT, oldStrokeMiterlimit, strokeMiterlimit, !oldStrokeMiterlimitESet));
	}
	...
	public void unsetStrokeMiterlimit() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.ELLIPSE_PRIMITIVE__STROKE_MITERLIMIT, oldStrokeMiterlimit, STROKE_MITERLIMIT_EDEFAULT, oldStrokeMiterlimitESet));
	}
	...
	public void setStrokeOpacity(Object newStrokeOpacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__STROKE_OPACITY, oldStrokeOpacity, strokeOpacity, !oldStrokeOpacityESet));
	}
	...
	public void unsetStrokeOpacity() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.ELLIPSE_PRIMITIVE__STROKE_OPACITY, oldStrokeOpacity, STROKE_OPACITY_EDEFAULT, oldStrokeOpacityESet));
	}
	...
	public void setStrokewidth(Object newStrokewidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__STROKEWIDTH, oldStrokewidth, strokewidth, !oldStrokewidthESet));
	}
	...
	public void unsetStrokewidth() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.ELLIPSE_PRIMITIVE__STROKEWIDTH, oldStrokewidth, STROKEWIDTH_EDEFAULT, oldStrokewidthESet));
	}
	...
	public void setTransform(String newTransform) {
		...
		transformESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__TRANSFORM, oldTransform, transform, !oldTransformESet));
	}
	...
	public void unsetTransform() {
		...
		transformESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.ELLIPSE_PRIMITIVE__TRANSFORM, oldTransform, TRANSFORM_EDEFAULT, oldTransformESet));
	}
	...
	public void setVisibility(Object newVisibility) {
		...
		visibilityESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ELLIPSE_PRIMITIVE__VISIBILITY, oldVisibility, visibility, !oldVisibilityESet));
	}
	...
	public void unsetVisibility() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.ELLIPSE_PRIMITIVE__VISIBILITY, oldVisibility, VISIBILITY_EDEFAULT, oldVisibilityESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Part2Package.ELLIPSE_PRIMITIVE__GROUP:
				return getGroup();
			case Part2Package.ELLIPSE_PRIMITIVE__CHILDREN:
				return getChildren();
			case Part2Package.ELLIPSE_PRIMITIVE__RECTANGLE:
				return getRectangle();
			case Part2Package.ELLIPSE_PRIMITIVE__CIRCLE:
				return getCircle();
			case Part2Package.ELLIPSE_PRIMITIVE__ELLIPSE:
				return getEllipse();
			case Part2Package.ELLIPSE_PRIMITIVE__LINE:
				return getLine();
			case Part2Package.ELLIPSE_PRIMITIVE__POLYLINE:
				return getPolyline();
			case Part2Package.ELLIPSE_PRIMITIVE__POLYGON:
				return getPolygon();
			case Part2Package.ELLIPSE_PRIMITIVE__PATH:
				return getPath();
			case Part2Package.ELLIPSE_PRIMITIVE__IMAGE:
				return getImage();
			case Part2Package.ELLIPSE_PRIMITIVE__TEXT:
				return getText();
			case Part2Package.ELLIPSE_PRIMITIVE__ARC:
				return getArc();
			case Part2Package.ELLIPSE_PRIMITIVE__CROWN:
				return getCrown();
			case Part2Package.ELLIPSE_PRIMITIVE__POLAR_LINE:
				return getPolarLine();
			case Part2Package.ELLIPSE_PRIMITIVE__POINTER_AREA:
				return getPointerArea();
			case Part2Package.ELLIPSE_PRIMITIVE__TOUCH_AREA:
				return getTouchArea();
			case Part2Package.ELLIPSE_PRIMITIVE__GESTURE_AREA:
				return getGestureArea();
			case Part2Package.ELLIPSE_PRIMITIVE__SCROLL_WHEEL_AREA:
				return getScrollWheelArea();
			case Part2Package.ELLIPSE_PRIMITIVE__KEYBOARD_INPUT:
				return getKeyboardInput();
			case Part2Package.ELLIPSE_PRIMITIVE__COMPOSITIONS:
				return getCompositions();
			case Part2Package.ELLIPSE_PRIMITIVE__CLIP_PATH:
				return getClipPath();
			case Part2Package.ELLIPSE_PRIMITIVE__CLIP_RULE:
				return getClipRule();
			...
			case Part2Package.ELLIPSE_PRIMITIVE__TRANSFORM:
				return getTransform();
			case Part2Package.ELLIPSE_PRIMITIVE__VISIBILITY:
