 ...
 * </p>
 * <ul>
 *   <li>{@link org.example.ng661.part2.impl.PropertyValueImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.PropertyValueImpl#getProperty <em>Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyValueImpl extends MinimalEObjectImpl.Container implements PropertyValue {
	...
	protected EClass eStaticClass() {
		return Part2Package.eINSTANCE.getPropertyValue();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.PROPERTY_VALUE__VALUE, oldValue, value));
	}
	...
	public PropertyType getProperty() {
		if (property != null && property.eIsProxy()) {
			...
			if (property != oldProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Part2Package.PROPERTY_VALUE__PROPERTY, oldProperty, property));
			}
		}
		return property;
	}
	...
	public void setProperty(PropertyType newProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.PROPERTY_VALUE__PROPERTY, oldProperty, property));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Part2Package.PROPERTY_VALUE__VALUE:
				return getValue();
			case Part2Package.PROPERTY_VALUE__PROPERTY:
