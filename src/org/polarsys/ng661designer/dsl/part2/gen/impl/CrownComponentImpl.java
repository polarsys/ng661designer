...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Crown Component</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getClipPath <em>Clip Path</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getClipRule <em>Clip Rule</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getDrawingPriority <em>Drawing Priority</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getFill <em>Fill</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getFillOpacity <em>Fill Opacity</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getFillRule <em>Fill Rule</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getInnerRadius <em>Inner Radius</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getOuterRadius <em>Outer Radius</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getStroke <em>Stroke</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getStrokeDasharray <em>Stroke Dasharray</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getStrokeDashoffset <em>Stroke Dashoffset</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getStrokeLinecap <em>Stroke Linecap</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getStrokeLinejoin <em>Stroke Linejoin</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getStrokeMiterlimit <em>Stroke Miterlimit</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getStrokeOpacity <em>Stroke Opacity</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getStrokewidth <em>Strokewidth</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getTransform <em>Transform</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getX <em>X</em>}</li>
 *   <li>{@link org.example.ng661.part2.impl.CrownComponentImpl#getY <em>Y</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CrownComponentImpl extends RepresentationTypesImpl implements CrownComponent {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @ordered
	 */
	protected static final Object INNER_RADIUS_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected Object innerRadius = INNER_RADIUS_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final Object OUTER_RADIUS_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected Object outerRadius = OUTER_RADIUS_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return Part2Package.eINSTANCE.getCrownComponent();
	}
	...
	public void setClipPath(String newClipPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__CLIP_PATH, oldClipPath, clipPath, !oldClipPathESet));
	}
	...
	public void unsetClipPath() {
		...
		clipPathESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.CROWN_COMPONENT__CLIP_PATH, oldClipPath, CLIP_PATH_EDEFAULT, oldClipPathESet));
	}
	...
	public void setClipRule(String newClipRule) {
		...
		clipRuleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__CLIP_RULE, oldClipRule, clipRule, !oldClipRuleESet));
	}
	...
	public void unsetClipRule() {
		...
		clipRuleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.CROWN_COMPONENT__CLIP_RULE, oldClipRule, CLIP_RULE_EDEFAULT, oldClipRuleESet));
	}
	...
	public void setDrawingPriority(Object newDrawingPriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__DRAWING_PRIORITY, oldDrawingPriority, drawingPriority, !oldDrawingPriorityESet));
	}
	...
	public void unsetDrawingPriority() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.CROWN_COMPONENT__DRAWING_PRIORITY, oldDrawingPriority, DRAWING_PRIORITY_EDEFAULT, oldDrawingPriorityESet));
	}
	...
	public void setFill(Object newFill) {
		...
		fillESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__FILL, oldFill, fill, !oldFillESet));
	}
	...
	public void unsetFill() {
		...
		fillESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.CROWN_COMPONENT__FILL, oldFill, FILL_EDEFAULT, oldFillESet));
	}
	...
	public void setFillOpacity(Object newFillOpacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__FILL_OPACITY, oldFillOpacity, fillOpacity, !oldFillOpacityESet));
	}
	...
	public void unsetFillOpacity() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.CROWN_COMPONENT__FILL_OPACITY, oldFillOpacity, FILL_OPACITY_EDEFAULT, oldFillOpacityESet));
	}
	...
	public void setFillRule(Object newFillRule) {
		...
		fillRuleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__FILL_RULE, oldFillRule, fillRule, !oldFillRuleESet));
	}
	...
	public void unsetFillRule() {
		...
		fillRuleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.CROWN_COMPONENT__FILL_RULE, oldFillRule, FILL_RULE_EDEFAULT, oldFillRuleESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__ID, oldId, id));
	}
	 ...
	 * @generated
	 */
	public void setInnerRadius(Object newInnerRadius) {
		Object oldInnerRadius = innerRadius;
		innerRadius = newInnerRadius;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__INNER_RADIUS, oldInnerRadius, innerRadius));
	}
	 ...
	 * @generated
	 */
	public void setOuterRadius(Object newOuterRadius) {
		Object oldOuterRadius = outerRadius;
		outerRadius = newOuterRadius;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__OUTER_RADIUS, oldOuterRadius, outerRadius));
	}
	...
	public void setStroke(Object newStroke) {
		...
		strokeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__STROKE, oldStroke, stroke, !oldStrokeESet));
	}
	...
	public void unsetStroke() {
		...
		strokeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.CROWN_COMPONENT__STROKE, oldStroke, STROKE_EDEFAULT, oldStrokeESet));
	}
	...
	public void setStrokeDasharray(String newStrokeDasharray) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__STROKE_DASHARRAY, oldStrokeDasharray, strokeDasharray, !oldStrokeDasharrayESet));
	}
	...
	public void unsetStrokeDasharray() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.CROWN_COMPONENT__STROKE_DASHARRAY, oldStrokeDasharray, STROKE_DASHARRAY_EDEFAULT, oldStrokeDasharrayESet));
	}
	...
	public void setStrokeDashoffset(Object newStrokeDashoffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__STROKE_DASHOFFSET, oldStrokeDashoffset, strokeDashoffset, !oldStrokeDashoffsetESet));
	}
	...
	public void unsetStrokeDashoffset() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.CROWN_COMPONENT__STROKE_DASHOFFSET, oldStrokeDashoffset, STROKE_DASHOFFSET_EDEFAULT, oldStrokeDashoffsetESet));
	}
	...
	public void setStrokeLinecap(String newStrokeLinecap) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__STROKE_LINECAP, oldStrokeLinecap, strokeLinecap, !oldStrokeLinecapESet));
	}
	...
	public void unsetStrokeLinecap() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.CROWN_COMPONENT__STROKE_LINECAP, oldStrokeLinecap, STROKE_LINECAP_EDEFAULT, oldStrokeLinecapESet));
	}
	...
	public void setStrokeLinejoin(String newStrokeLinejoin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__STROKE_LINEJOIN, oldStrokeLinejoin, strokeLinejoin, !oldStrokeLinejoinESet));
	}
	...
	public void unsetStrokeLinejoin() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.CROWN_COMPONENT__STROKE_LINEJOIN, oldStrokeLinejoin, STROKE_LINEJOIN_EDEFAULT, oldStrokeLinejoinESet));
	}
	...
	public void setStrokeMiterlimit(Object newStrokeMiterlimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__STROKE_MITERLIMIT, oldStrokeMiterlimit, strokeMiterlimit, !oldStrokeMiterlimitESet));
	}
	...
	public void unsetStrokeMiterlimit() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.CROWN_COMPONENT__STROKE_MITERLIMIT, oldStrokeMiterlimit, STROKE_MITERLIMIT_EDEFAULT, oldStrokeMiterlimitESet));
	}
	...
	public void setStrokeOpacity(Object newStrokeOpacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__STROKE_OPACITY, oldStrokeOpacity, strokeOpacity, !oldStrokeOpacityESet));
	}
	...
	public void unsetStrokeOpacity() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.CROWN_COMPONENT__STROKE_OPACITY, oldStrokeOpacity, STROKE_OPACITY_EDEFAULT, oldStrokeOpacityESet));
	}
	...
	public void setStrokewidth(Object newStrokewidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__STROKEWIDTH, oldStrokewidth, strokewidth, !oldStrokewidthESet));
	}
	...
	public void unsetStrokewidth() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.CROWN_COMPONENT__STROKEWIDTH, oldStrokewidth, STROKEWIDTH_EDEFAULT, oldStrokewidthESet));
	}
	...
	public void setTransform(String newTransform) {
		...
		transformESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__TRANSFORM, oldTransform, transform, !oldTransformESet));
	}
	...
	public void unsetTransform() {
		...
		transformESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.CROWN_COMPONENT__TRANSFORM, oldTransform, TRANSFORM_EDEFAULT, oldTransformESet));
	}
	...
	public void setVisibility(Object newVisibility) {
		...
		visibilityESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__VISIBILITY, oldVisibility, visibility, !oldVisibilityESet));
	}
	...
	public void unsetVisibility() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.CROWN_COMPONENT__VISIBILITY, oldVisibility, VISIBILITY_EDEFAULT, oldVisibilityESet));
	}
	...
	public void setX(Object newX) {
		...
		x = newX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__X, oldX, x));
	}
	...
	public void setY(Object newY) {
		...
		y = newY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.CROWN_COMPONENT__Y, oldY, y));
	}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case Part2Package.CROWN_COMPONENT__INNER_RADIUS:
				...
				return;
			case Part2Package.CROWN_COMPONENT__OUTER_RADIUS:
				setOuterRadius(OUTER_RADIUS_EDEFAULT);
				return;
			case Part2Package.CROWN_COMPONENT__STROKE:
				unsetStroke();
				return;
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case Part2Package.CROWN_COMPONENT__OUTER_RADIUS:
				return OUTER_RADIUS_EDEFAULT == null ? outerRadius != null : !OUTER_RADIUS_EDEFAULT.equals(outerRadius);
			case Part2Package.CROWN_COMPONENT__STROKE:
				return isSetStroke();
			case Part2Package.CROWN_COMPONENT__STROKE_DASHARRAY:
