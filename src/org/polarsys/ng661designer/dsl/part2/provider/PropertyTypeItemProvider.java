...
/**
 * This is the item provider adapter for a {@link org.example.ng661.part2.PropertyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PropertyType_maxStringLength_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertyType_maxStringLength_feature", "_UI_PropertyType_type"),
	...
	protected void addModalityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PropertyType_modality_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertyType_modality_feature", "_UI_PropertyType_type"),
