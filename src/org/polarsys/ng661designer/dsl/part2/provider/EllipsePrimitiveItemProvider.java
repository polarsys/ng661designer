...
/**
 * This is the item provider adapter for a {@link org.example.ng661.part2.EllipsePrimitive} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EllipsePrimitiveItemProvider extends ClipRepresentationTypesItemProvider {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EllipsePrimitive_clipPath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EllipsePrimitive_clipPath_feature", "_UI_EllipsePrimitive_type"),
	...
	protected void addClipRulePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EllipsePrimitive_clipRule_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EllipsePrimitive_clipRule_feature", "_UI_EllipsePrimitive_type"),
	...
	protected void addTransformPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EllipsePrimitive_transform_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EllipsePrimitive_transform_feature", "_UI_EllipsePrimitive_type"),
	...
	protected void addVisibilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EllipsePrimitive_visibility_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EllipsePrimitive_visibility_feature", "_UI_EllipsePrimitive_type"),
