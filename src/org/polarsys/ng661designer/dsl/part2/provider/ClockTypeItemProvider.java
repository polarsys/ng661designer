...
/**
 * This is the item provider adapter for a {@link org.example.ng661.part2.ClockType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClockTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ClockType_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ClockType_id_feature", "_UI_ClockType_type"),
	...
	public String getText(Object object) {
		String label = ((ClockType)object).getId();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ClockType.class)) {
			case Part2Package.CLOCK_TYPE__ID:
