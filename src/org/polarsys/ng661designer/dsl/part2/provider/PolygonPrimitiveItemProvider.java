...
/**
 * This is the item provider adapter for a {@link org.example.ng661.part2.PolygonPrimitive} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PolygonPrimitiveItemProvider extends RepresentationTypesItemProvider {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected void addPointsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PolygonPrimitive_points_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PolygonPrimitive_points_feature", "_UI_PolygonPrimitive_type"),
	...
	protected void addTransformPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PolygonPrimitive_transform_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PolygonPrimitive_transform_feature", "_UI_PolygonPrimitive_type"),
	...
	protected void addVisibilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PolygonPrimitive_visibility_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PolygonPrimitive_visibility_feature", "_UI_PolygonPrimitive_type"),
