...
/**
 * This is the item provider adapter for a {@link org.example.ng661.part2.PropertyValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyValueItemProvider 
	...
	public String getText(Object object) {
		...
		if (((PropertyValue)object).getProperty() != null) {
			label += ((PropertyValue)object).getProperty().getName();
		}
		if (((PropertyValue)object).getValue() != null) {
			label += ": "+((PropertyValue)object).getValue();
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PropertyValue.class)) {
			case Part2Package.PROPERTY_VALUE__VALUE:
