...
/**
 * This is the item provider adapter for a {@link org.example.ng661.part2.BehaviorType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BehaviorTypeItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Part2Package.eINSTANCE.getBehaviorType_BehaviorGroup());
			childrenFeatures.add(Part2Package.eINSTANCE.getBehaviorType_Scxml());
			childrenFeatures.add(Part2Package.eINSTANCE.getBehaviorType_Clock());
			childrenFeatures.add(Part2Package.eINSTANCE.getBehaviorType_Function());
		}
	...
	public String getText(Object object) {
		return getString("_UI_BehaviorType_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Part2Package.eINSTANCE.getBehaviorType_Scxml(),
				 ScxmlFactory.eINSTANCE.createScxmlScxmlType()));

		newChildDescriptors.add
			(createChildParameter
				(Part2Package.eINSTANCE.getBehaviorType_Clock(),
				 Part2Factory.eINSTANCE.createClockType()));

		newChildDescriptors.add
			(createChildParameter
				(Part2Package.eINSTANCE.getBehaviorType_Function(),
